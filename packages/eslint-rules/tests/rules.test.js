...
tester.run("signal-boundaries", rules["signal-boundaries"], {
  ...
  invalid: [invalid("export const data$ = state(0);"), invalid("const data = state(0);"),
    ...
    { code: 'import * as cc from "ccstate"; export const data$ = cc.state(0);', errors: [{ messageId: "invalid" }] },
    { code: 'import * as cc from "ccstate"; const data = cc["state"](0);', errors: [{ messageId: "invalid" }] },
